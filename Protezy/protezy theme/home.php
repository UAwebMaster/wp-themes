<?php get_header(); ?>
    ...
    <div id="exContent">
        <div id="exLeftColumn">
            <p><iframe width="560" height="315" src="https://www.youtube.com/embed/4gKMMGDBVts" frameborder="0" allowfullscreen></iframe></p>
        </div>
        <div id="exRightColumn">
			<h3> Контактні дані </h3>
			<p>вул. Львівська 68, Жешув</p>
			<p>90 м від лікарні "на Гурці"</p>
			<p>інформація українською мовою:</p>
			<p>тел. моб. +48 608-591-481</p>
			<p>email: biuro@protezynog.pl</p>
			<br/>
			<p style="text-align: right;"><a class="exLink" href="http://protezynig.com.ua/pro-firmu/punkty-pryjomu/rzeszuvskyj-zaklad-ortopedychnyj/"><strong>читай більше...</strong></a></p>
			<center>
				<a href="https://www.youtube.com/channel/UC3ExjdoEAKTT9US8Zeo41pQ" target="_blank"><img src="http://protezynog.pl/wp-content/uploads/2015/02/YouTube-logo-full_color2.png"></a>
			</center>
        </div>
			...
			<div id="recent-work" class="clearfix">
				...
				<?php
					...
					while ( $recent_work_query->have_posts() ) : $recent_work_query->the_post();
						++$work_count;
						$width = (int) apply_filters( 'evolution_home_work_width', 310 );
						$height = (int) apply_filters( 'evolution_home_work_height', 160 );
				...
				?>
						<div class="r-work<?php if ( 0 == $work_count % 3 ) echo ' last'; ?>">
							...
							<a href="<?php $etlink = get_post_meta($post->ID, 'etlink', true); if($etlink != '') echo $etlink; else the_permalink(); ?>" class="more"></a>
